...
-- 创建用户
grant all privileges on ApolloConfigDB.* to ApolloConfigDB@localhost identified by '123456';
grant all privileges on ApolloConfigDB.* to ApolloConfigDB@'%' identified by '123456';
flush privileges;
