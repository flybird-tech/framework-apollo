...
-- 创建用户
grant all privileges on ApolloPortalDB.* to ApolloPortalDB@localhost identified by '123456';
grant all privileges on ApolloPortalDB.* to ApolloPortalDB@'%' identified by '123456';
flush privileges;
...
VALUES
    ...
    ('organizations', '[{\"orgId\":\"TEST1\",\"orgName\":\"开发部1\"},{\"orgId\":\"TEST2\",\"orgName\":\"开发部2\"}]', '部门列表'),
